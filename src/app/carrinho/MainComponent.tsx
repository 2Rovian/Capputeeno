            ...
            {isLoading ?
                ...
                : !produtosCarrinho.length ?
                    (<div className="flex flex-col justify-center">
                        <div className='flex flex-col gap-y-4 justify-center items-center w-[80%] max-w-xl mx-auto py-6 lg:py-8 px-4 bg-gray-900 text-white rounded-xl mt-10 lg:gap-y-8 duration-300 ease-in-out shadow'>
                            ...
                            <div className="flex flex-col">
                                ...
                                <Link href='/'
                                    className='px-6 py-2 bg-white text-gray-900 rounded-2xl mt-2 self-center font-semibold hover:scale-105 duration-200 ease-in-out'
